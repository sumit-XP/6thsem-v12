...
This script trains an RT-DETR model using the downloaded weights and configuration.
"""
...
def main():
    """Main training function for RT-DETR."""
    ...
    save_dir = "runs/train_rtdetr"
    os.makedirs(save_dir, exist_ok=True)

    print("=" * 70)
    print("RT-DETR Training Configuration")
    print("=" * 70)
